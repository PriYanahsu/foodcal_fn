...
export default function HeroSection() {
    const features = [
        {
            title: "Snap & Scan",
            description: "Simply point your camera at any meal. Our advanced AI instantly identifies ingredients and portion sizes in seconds.",
            icon: <CameraIcon className="w-7 h-7" />,
        },
        {
            title: "AI Analysis",
            description: "Get detailed nutritional breakdowns including calories, protein, carbs, and fats with 98% accuracy.",
            icon: <FireIcon className="w-7 h-7" />,
        },
        {
            title: "Track Progress",
            description: "Automatically log your daily intake and visualize your journey towards your health goals with beautiful charts.",
            icon: <ChartBarIcon className="w-7 h-7" />,
        },
        {
            title: "Get Coached",
            description: "Receive personalized tips and feedback from your AI Health Coach safely based on your eating habits.",
        ...
        <div className="relative w-full min-h-[85vh] flex flex-col justify-center overflow-hidden py-12">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 w-full">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16 space-y-6">
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tight animate-slide-up" style={{ animationDelay: '0.1s' }}>
                        Eat Smarter. <br />
                    ...
                    <p className="text-[var(--text-muted)] text-lg md:text-xl leading-relaxed animate-slide-up" style={{ animationDelay: '0.2s' }}>
                        Experience the easiest way to track your diet. Just snap a photo, and let our AI handle the rest. No more manual entry.
                    </p>
