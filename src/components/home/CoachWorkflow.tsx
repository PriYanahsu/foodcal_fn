...
const WorkflowStep = ({ icon, title, description, delay }: { icon: any, title: string, description: string, delay: number }) => (
    <motion.div
                            ...
                            <div className="relative z-20 h-full flex flex-col p-8 space-y-8">
                                ...
                                >
                                    ...
                                    <div className="space-y-0.5">
                                        <p className="text-[10px] font-black uppercase tracking-widest text-[var(--primary)]">AI Coach Alert</p>
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-xs font-black uppercase tracking-tight text-[var(--text-muted)]">Pro Coach Feedback</span>
                                    </div>
                                    <p className="text-sm leading-relaxed italic">
                                        "I noticed you've increased your protein by 20% this week. This is perfect for muscle recovery. Try adding 200ml more water to stay hydrated!"
                                    </p>
                                    <div className="flex items-center gap-2 pt-2">
                                        ...
                                        <span className="text-[10px] font-bold text-[var(--primary)]">WEEKLY GOAL: 85%</span>
                                    </div>
                                </motion.div>
                            </div>
