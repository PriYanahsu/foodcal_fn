...
export function StatCard({ label, value, unit, icon, color = '#2f81f7', progress, delay = 0 }: StatCardProps) {
    return (
        <motion.div
        ...
        >
            ...
            <div className="flex justify-between items-start mb-4">
                <div>
                    <p className="text-[var(--text-muted)] text-xs font-bold uppercase tracking-widest mb-1">{label}</p>
                ...
                <div
                    className="w-10 h-10 rounded-xl flex items-center justify-center text-xl bg-white/5 border border-white/5 shadow-inner"
                >
                    {icon}
                </div>
            </div>
