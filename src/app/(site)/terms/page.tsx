    ...
    <div className="min-h-screen pt-24 pb-16 px-4 md:px-6">
      <div className="max-w-4xl mx-auto space-y-12 animate-fade-in">
        ...
        <section className="glass-card p-8 md:p-12 space-y-8 leading-relaxed text-[var(--text-muted)]">
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[var(--foreground)]">2. Description of Service</h2>
            <p>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[var(--foreground)]">4. Health Disclaimer</h2>
            <p className="bg-red-500/5 border border-red-500/20 p-4 rounded-xl text-red-200">
              <strong className="text-[var(--foreground)] block mb-1">IMPORTANT:</strong> FoodCal and its AI Coach
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[var(--foreground)]">5. Intellectual Property</h2>
            <p>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[var(--foreground)]">6. Limitation of Liability</h2>
            <p>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-bold text-[var(--foreground)]">7. Changes to Terms</h2>
            <p>
