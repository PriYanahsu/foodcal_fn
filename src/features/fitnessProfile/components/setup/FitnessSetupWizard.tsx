  ...
  const handleSavePlan = async () => {
    ...
    try {
      const { data } = await axiosInstance.put<FitnessDetails>(`/v1/fitness/update`, {
        ...
        targetWeightKg: goals.target_weight,
        targetDate: goals.target_date,
        dailyCalorieTarget: aiResult.targets.calories,
        dailyProteinTargetG: aiResult.targets.protein,
        dailyCarbsTargetG: aiResult.targets.carbs,
        dailyFatTargetG: aiResult.targets.fats,
