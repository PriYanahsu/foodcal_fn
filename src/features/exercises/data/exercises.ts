...
export const EXERCISES: Exercise[] = [
  ...
  // Beginner
  {
    ...
    muscleGroup: 'chest',
    description:
      'A beginner-friendly push-up variation performed against a wall to build base strength.',
    difficulty: 'beginner',
    equipment: ['Wall'],
    steps: [
  ...
  },
  {
    ...
    steps: [
      'Start in plank but with knees on the floor.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Perform a standard push-up motion.',
  ...
  },
  {
    ...
    steps: [
      'Wrap band around a pole or your back.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Press dumbbells up from the floor.',
  ...
  },
  {
    ...
    equipment: ['Bodyweight'],
    steps: [
      'Hold the bottom position of a push-up.',
      'Keep core tight.',
