...
export const AiScanOverlay: React.FC<AiScanOverlayProps> = ({ prompt = '' }) => {
  ...
  return (
    <div className="absolute inset-0 z-10 pointer-events-none overflow-hidden">
      ...
      {/* Targeting reticle */}
      <div className="absolute inset-8 rounded-[1.75rem] border border-[var(--primary)]/35">
        ...
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(to right, rgba(0,255,136,0.07) 1px, transparent 1px), linear-gradient(to bottom, rgba(0,255,136,0.07) 1px, transparent 1px)',
      ...
      <div className="absolute top-5 left-5 z-30">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/65 border border-[var(--primary)]/35 backdrop-blur-md">
      ...
      {chips.slice(0, visibleChips).map((label, i) => {
        ...
        return (
          <motion.div
            ...
            style={pos}
          >
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/75 border border-[var(--primary)]/45 backdrop-blur-md shadow-[0_0_24px_rgba(0,255,136,0.18)]">
              <span className="w-1.5 h-1.5 rounded-full bg-[var(--primary)] animate-pulse" />
              <span className="text-[10px] font-bold tracking-wide text-white/90">{label}</span>
      ...
      <div className="absolute inset-x-0 bottom-0 p-4 z-30">
        <div className="mx-auto max-w-sm rounded-2xl bg-black/80 border border-white/10 backdrop-blur-xl px-4 py-3.5 shadow-2xl space-y-3">
