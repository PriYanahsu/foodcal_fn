      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute left-0 top-full z-50 mt-2 w-[min(320px,calc(100vw-2rem))] origin-top-left rounded-3xl border border-line-strong bg-surface-1 p-4 shadow-[var(--fc-shadow-pop)]"
          >
