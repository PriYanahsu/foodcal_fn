...
export const DEMO_STEPS: DemoStep[] = [
  {
    ...
    description:
      'Tell our AI your height, weight, age, and activity level. Get instant personalized macro targets.',
    icon: UserIcon,
    color: 'from-violet-500 to-purple-400',
    details:
      'The AI analyzes your body metrics and lifestyle to calculate your perfect daily calorie, protein, carbs, and fat targets.',
    fullExplanation: {
      overview:
        'Our AI-powered profile setup creates a personalized nutrition plan tailored specifically to your body and goals.',
      howItWorks: [
  ...
  },
  {
    title: 'Set Your Goal',
    description:
      "Choose weight loss, gain, or maintain. Set your target weight and timeline—AI validates it's healthy.",
    icon: TrophyIcon,
    color: 'from-amber-500 to-orange-400',
    details:
      'Our AI coach ensures your goals are realistic and sustainable, suggesting adjustments if needed for your safety.',
    fullExplanation: {
      overview:
        'Set ambitious yet achievable goals with AI validation to ensure your health and success.',
      howItWorks: [
  ...
  },
  {
    title: 'Snap & Identify',
    description:
      'Point your camera at any meal. AI identifies ingredients and portions in seconds.',
    icon: CameraIcon,
    color: 'from-blue-500 to-cyan-400',
    details:
      'Advanced computer vision recognizes food items, estimates serving sizes, and logs everything automatically.',
    fullExplanation: {
      overview:
        "Say goodbye to manual food logging. Our AI-powered camera instantly recognizes what you're eating.",
      howItWorks: [
  ...
  },
  {
    ...
    description:
      'Automatic calorie and macronutrient calculation. Zero manual data entry required.',
    icon: ChartPieIcon,
    color: 'from-emerald-500 to-teal-400',
    details:
      'See real-time updates on your dashboard showing calories, protein, carbs, and fats consumed vs. your targets.',
    fullExplanation: {
      overview:
        'Every scanned meal instantly updates your macro totals—no math, no guessing, just results.',
      howItWorks: [
  ...
  },
  {
    ...
    description:
      "Track your daily progress with beautiful charts. See if you're on track or falling behind.",
    icon: ClipboardDocumentListIcon,
    color: 'from-pink-500 to-rose-400',
    details:
      'Visual progress bars, meal history, and AI-generated advice appear when you need a boost to hit your goals.',
    fullExplanation: {
      overview:
        'Your personal nutrition command center—see everything at a glance with stunning visualizations.',
      howItWorks: [
  ...
  },
  {
    title: 'AI Coaching',
    description:
      "Get personalized advice when you're off track. The AI knows when to motivate you.",
    icon: SparklesIcon,
    color: 'from-indigo-500 to-blue-400',
    details:
      "If you're 500 kcal behind at 8 PM, the AI sends targeted suggestions to help you catch up or adjust tomorrow's plan.",
    fullExplanation: {
      overview:
        'Your 24/7 personal nutrition coach that knows exactly when and how to help you succeed.',
      howItWorks: [
  ...
  },
  {
    ...
    details:
      'More active days = slightly higher calorie allowance. The AI adjusts your targets dynamically based on movement.',
    fullExplanation: {
      overview:
        'Your activity level matters. We track your steps and adjust your nutrition plan accordingly.',
      howItWorks: [
  ...
  },
  {
    ...
    details:
      'Get reminders to log meals, motivational messages, and progress updates delivered at the perfect time.',
    fullExplanation: {
      overview:
        "Stay on track with intelligent notifications that work even when you're not using the app.",
      howItWorks: [
  ...
  },
  {
    ...
    details:
      'Browse your food diary by date, analyze patterns, and learn from your nutrition journey over time.',
    fullExplanation: {
      overview:
        'Your complete food diary with photos, macros, and insights to learn from your journey.',
      howItWorks: [
    ...
    <>
      ...
      >
        ...
        <div className="flex items-start gap-4">
          <div
            className={`w-12 h-12 rounded-xl bg-gradient-to-br ${step.color} p-2.5 shadow-lg flex items-center justify-center text-white flex-shrink-0`}
          >
      ...
      <FeatureModal feature={step} isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
    </>
  );
};
