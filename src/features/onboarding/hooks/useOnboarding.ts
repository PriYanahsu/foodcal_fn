...
export function useOnboarding() {
  ...
  return {
    ...
    /** The plan check itself failed (network, backend down) — not the same as "no plan". */
    planCheckFailed: fitnessQuery.isError && !planKnown,
    retryPlanCheck: fitnessQuery.refetch,
